	...
	app.Commands = []*cli.Command{
		{
			...
			Flags: []cli.Flag{
				&cli.StringFlag{
					Value:   "127.0.0.1:5141",
					Name:    "udp-listen",
					Aliases: []string{"listen"},
					Usage:   "Listen syslog RFC3164",
					EnvVars: []string{"ASM_NGINX_LOG_PARSER_ACCESS_LOG_UDP_LISTEN"},
				},
				&cli.StringFlag{
					Value:   "127.0.0.1:6141",
					Name:    "tcp-server",
					Aliases: []string{"tcp"},
					Usage:   "Target TCP server",
					EnvVars: []string{"ASM_NGINX_LOG_PARSER_ACCESS_LOG_TCP_SERVER"},
				},
			},
		...
		},
		{
			...
			Flags: []cli.Flag{
				&cli.StringFlag{
					Value:   "127.0.0.1:5140",
					Name:    "udp-listen",
					Aliases: []string{"listen"},
					Usage:   "Listen syslog RFC3164",
					EnvVars: []string{"ASM_NGINX_LOG_PARSER_ERROR_LOG_UDP_LISTEN"},
				},
				&cli.StringFlag{
					Value:   "127.0.0.1:6140",
					Name:    "tcp-server",
					Aliases: []string{"tcp"},
					Usage:   "Target TCP server",
					EnvVars: []string{"ASM_NGINX_LOG_PARSER_ERROR_LOG_TCP_SERVER"},
				},
			},
